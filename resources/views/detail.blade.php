    ...
    <div class="my-20 max-w-screen-xl mx-auto shadow-2xl">
        <form action="{{ route('postKeranjang', $event->id) }}" method="POST">
            ...
            <div class="mx-5">
                ...
                <div class="mx-5 my-5">
                    <h1 class="font-bold text-2xl md:text-3xl">{{ $event->name }}</h1>
                    <p class="md:text-lg mt-1">stock : {{ $event->stock }}</p>
                    <div class="md:text-lg mt-3">
                        {{ $event->deskripsi }}
                    </div>
                </div>
            </div>
            <div class="mx-5 grid grid-cols-3 my-10">
                <div class="text-center">
                    <p class="font-bold text-2xl">Waktu</p>
                    <p class="mt-3 md:text-lg">{{ $event->date }}</p>
                </div>
                <div class="text-center">
                    <p class="font-bold text-2xl">Jam</p>
                    <p class="mt-3 md:text-lg">{{ $event->time }}</p>
                </div>
                <div class="text-center">
